<?php
require("../services/class/encuestas/conexion.php");
...
function cupon($codigo,$padre,$hijo,$cantdiv){
	...
	<div class="troq-ladoder">
		<div class="divqr"><img src="genera_qr.php?codigo='.$codigo.'"/><br>
		O Escaneame!<br>
...
// 		}
	...
	echo '<a href="javascript:window.print()" id="btnprint"><B>IMPRIMIR</B></a>';
}
if ($_REQUEST["print"] == "1") {
